...
<body>
    ...
    <a href="list.php">Listagem de Denúncias </a><br>
    <h3> Listagem das Usuários </h3>
    <?php
        ...
        $result_denuncia = "SELECT * FROM usuarios LIMIT $inicio, $qnt_result_pg";
        ...
        while($row_denuncia = mysqli_fetch_assoc($resultado_denuncia)){
            ...
            echo "Nome: " . $row_denuncia['nome']."<br>";
            echo "E-mail: " . $row_denuncia['email']."<br>";
            echo "Senha: " . $row_denuncia['senha']."<br><hr>";
        }
